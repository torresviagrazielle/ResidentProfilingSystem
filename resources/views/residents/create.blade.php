                ...
                <div class="card-body">
                    <form method="POST" action="/residents">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="middlename" type="text" class="form-control" name="lastname" value="{{ old('lastname') }}">        
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="extname" type="text" class="form-control" name="extname" value="{{ old('extname') }}">        
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="house_num" type="text" class="form-control" name="house_num" value="{{ old('house_num') }}" required  autofocus>        
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="barangay" type="text" class="form-control" name="barangay" value="{{ old('barangay') }}" required  autofocus>        
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="civil_status" type="text" class="form-control" name="civil_status" value="{{ old('civil_status') }}" required  autofocus>        
                            </div>
                        </div>
